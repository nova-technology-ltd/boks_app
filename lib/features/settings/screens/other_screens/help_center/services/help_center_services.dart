...
class HelpCenterServices {
  ...
  Future<int> makeCompliant(
    ...
    try {
      final response = await http.post(
          Uri.parse("$baseUrl/api/v1/boks/complaint/new-complaint"),
          headers: {
  ...
  Future<List<Map<String, dynamic>>> getAllUserCompliant(BuildContext context) async {
    try {
      ...
      final response = await http.get(
        Uri.parse("$baseUrl/api/v1/boks/complaint/all-complaints/user"),
        headers: {
          "Content-Type": "application/json",
  ...
  Future<Map<String, dynamic>> getCompliantByYD(BuildContext context, String complaintID) async {
    try {
      ...
      final Uri url = Uri.parse("$baseUrl/api/v1/boks/complaint/compliant-by-ID/$complaintID");
      final response = await http.get(
        url,
        headers: {
          "Content-Type": "application/json",
      ...
      debugPrint("Error in getCompliantByYD: $e");
  ...
  Future<List<Map<String, dynamic>>> getAllUserSatisfiedCompliant(BuildContext context) async {
    try {
      ...
      final response = await http.get(
        Uri.parse("$baseUrl/api/v1/boks/complaint/satisfied-compliants/user"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer $token",
        },
  ...
  Future<List<Map<String, dynamic>>> getAllUserUnsatisfiedCompliant(BuildContext context) async {
    try {
      ...
      final response = await http.get(
        Uri.parse("$baseUrl/api/v1/boks/complaint/unsatisfied-compliants/user"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer $token",
        },
  ...
  Future<int> deleteUserComplaint(
    ...
    try {
      ...
      final response = await http.delete(
        Uri.parse(
            "$baseUrl/api/v1/boks/complaint/delete-compliants/user"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer $token"
        },
  ...
  Future<void> deleteUserComplaintContent(
    ...
    try {
      ...
      final response = await http.delete(
        Uri.parse(
            "$baseUrl/api/v1/boks/complaint/delete-compliants-content/user"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer $token"
        },
  ...
  Future<int> addMoreContentToCompliant(BuildContext context, String complaintID, String message,
    ...
    try {
      ...
      String? token = prefs.getString("Authorization");
      final response = await http.post(
          Uri.parse("$baseUrl/api/v1/boks/complaint/add-complaint"),
          headers: {
            "Content-Type": "application/json",
            "Authorization": "Bearer $token"
          },
  ...
  Future<void> toggleCompliantStatus(BuildContext context, String complaintID) async {
    try {
      ...
      String? token = prefs.getString("Authorization");
      final response = await http.post(
          Uri.parse("$baseUrl/api/v1/boks/complaint/toggle-status"),
          headers: {
            "Content-Type": "application/json",
            "Authorization": "Bearer $token"
          },
