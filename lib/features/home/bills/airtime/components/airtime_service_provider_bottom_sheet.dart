...
import 'airtime_network_card.dart';

class AirtimeServiceProviderBottomSheet extends StatefulWidget {
  const AirtimeServiceProviderBottomSheet({super.key});

  @override
  State<AirtimeServiceProviderBottomSheet> createState() => _AirtimeServiceProviderBottomSheetState();
}

class _AirtimeServiceProviderBottomSheetState extends State<AirtimeServiceProviderBottomSheet> {
                          ...
                          AirtimeNetworkCard(
                            ...
                            onClick: () {
                              ...
                              final provider = AirtimeModelProvider(
                                id: services[i] ?? '',
                                imageUrl: imageUrl, name: title[i],
                              );
                              Provider.of<AirtimeProvider>(context, listen: false).selectProvider(provider);
