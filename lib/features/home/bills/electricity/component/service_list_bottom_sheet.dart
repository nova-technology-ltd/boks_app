...
import 'electricity_service_provider_shimmer_loader.dart';

class ServiceListBottomSheet extends StatefulWidget {
  final Future<List<Map<String, dynamic>>> futureService;

  const ServiceListBottomSheet({super.key, required this.futureService});
                      ...
                      return Column(
                        children: [
                          for (var provider in providers)
                            ElectricityServiceProviderCardStyle(data: provider)
                        ],
                      );
                    }
                  },
